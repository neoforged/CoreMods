...
project {
    ...
    params {
        ...
        text("docker_gradle_version", "7.0.2", label = "Gradle version", description = "The version of Gradle to use during execution of Gradle tasks.", display = ParameterDisplay.HIDDEN, allowEmpty = false)
    }

    features {
        githubIssues {
            id = "CoreMods__IssueTracker"
            displayName = "neoforged/CoreMods"
            repositoryURL = "https://github.com/neoforged/CoreMods"
        }
    }
}
...
object BuildSecondaryBranches : BuildType({
    ...
    id("CoreMods__BuildSecondaryBranches")
